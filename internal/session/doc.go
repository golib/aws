...
When creating Sessions optional internal.Config values can be passed in that will
...
Requires the AWS_PROFILE to be set, or "default" is used.
	...
	sess, err := session.NewSession(&internal.Config{Region: internal.String("us-east-1")})
...
SDK defaults, and user provided internal.Config values.
