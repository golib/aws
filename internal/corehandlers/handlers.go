...
var SDKVersionUserAgentHandler = request.NamedHandler{
	...
	Fn:   request.MakeAddToUserAgentHandler(internal.SDKName, internal.SDKVersion, runtime.Version(), runtime.GOOS, runtime.GOARCH),
}
...
var SendHandler = request.NamedHandler{
	...
	Fn: func(r *request.Request) {
		...
		if err != nil {
			// Prevent leaking if an HTTPResponse was returned. Clean up the body.
			...
			r.Retryable = internal.Bool(true) // network errors are retryable
		}
	},
}
...
var AfterRetryHandler = request.NamedHandler{
	...
	Fn: func(r *request.Request) {
		...
		if r.Retryable == nil {
			r.Retryable = internal.Bool(r.ShouldRetry(r))
		}
...
var ValidateEndpointHandler = request.NamedHandler{
	...
	Fn: func(r *request.Request) {
		if r.ClientInfo.SigningRegion == "" && internal.StringValue(r.Config.Region) == "" {
			r.Error = internal.ErrMissingRegion
		} else if r.ClientInfo.Endpoint == "" {
			r.Error = internal.ErrMissingEndpoint
		}
	},
}
