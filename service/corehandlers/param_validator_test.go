...
func TestNoErrors(t *testing.T) {
	input := &StructShape{
		...
		RequiredMap: map[string]*ConditionalStructShape{
			"key1": {Name: service.String("Name")},
			"key2": {Name: service.String("Name")},
		},
		RequiredBool:   service.Bool(true),
		OptionalStruct: &ConditionalStructShape{Name: service.String("Name")},
	}
...
var testsFieldMin = []struct {
...
}{
	{
		...
		in: testInput{StringField: service.String("abcd")},
	},
	{
		err: func() awserr.Error {
			invalidParams := request.ErrInvalidParams{Context: "testInput"}
		...
		in: testInput{StringField: service.String("abcd"), ListField: []string{"a", "b"}},
	},
	{
		err: func() awserr.Error {
			invalidParams := request.ErrInvalidParams{Context: "testInput"}
		...
		in: testInput{StringField: service.String("abcd"), ListField: []string{"a", "b"}, MapField: map[string]string{"a": "a", "b": "b"}},
	},
	{
		err: nil,
		in: testInput{StringField: service.String("abcde"),
