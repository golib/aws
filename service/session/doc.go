...
When creating Sessions optional service.Config values can be passed in that will
...
Requires the AWS_PROFILE to be set, or "default" is used.
	...
	sess, err := session.NewSession(&service.Config{Region: service.String("us-east-1")})
...
SDK defaults, and user provided service.Config values.
